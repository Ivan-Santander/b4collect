 ...
 */
@Entity
@Table(name = "weight_summary")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class WeightSummary implements Serializable {
    ...
    public WeightSummary id(UUID id) {
        this.setId(id);
        return this;
    }
    ...
    public WeightSummary usuarioId(String usuarioId) {
    ...
    public WeightSummary empresaId(String empresaId) {
    ...
    public WeightSummary fieldAverage(Float fieldAverage) {
    ...
    public WeightSummary fieldMax(Float fieldMax) {
    ...
    public WeightSummary fieldMin(Float fieldMin) {
    ...
    public WeightSummary startTime(Instant startTime) {
    ...
    public WeightSummary endTime(Instant endTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WeightSummary)) {
            return false;
        }
        return id != null && id.equals(((WeightSummary) o).id);
    }
