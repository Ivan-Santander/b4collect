...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISTANCEDELTA_LIST actions', async () => {
    ...
    it('dispatches FETCH_DISTANCEDELTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DISTANCEDELTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DISTANCEDELTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DISTANCEDELTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DISTANCEDELTA actions', async () => {
      const expectedActions = [
        {
