...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './blood-pressure-summary.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BLOODPRESSURESUMMARY_LIST actions', async () => {
    ...
    it('dispatches FETCH_BLOODPRESSURESUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BLOODPRESSURESUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BLOODPRESSURESUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BLOODPRESSURESUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BLOODPRESSURESUMMARY actions', async () => {
      const expectedActions = [
        {
