...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STEPCOUNTDELTA_LIST actions', async () => {
    ...
    it('dispatches FETCH_STEPCOUNTDELTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STEPCOUNTDELTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STEPCOUNTDELTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STEPCOUNTDELTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STEPCOUNTDELTA actions', async () => {
      const expectedActions = [
        {
