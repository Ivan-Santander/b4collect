...
/**
 * Criteria class for the {@link com.be4tech.b4carecollect.domain.ActiveMinutes} entity. This class is used
 * in {@link com.be4tech.b4carecollect.web.rest.ActiveMinutesResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /active-minutes?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ActiveMinutesCriteria implements Serializable, Criteria {
    ...
    public ActiveMinutesCriteria() {}

    public ActiveMinutesCriteria(ActiveMinutesCriteria other) {
    ...
    @Override
    public ActiveMinutesCriteria copy() {
        return new ActiveMinutesCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ActiveMinutesCriteria that = (ActiveMinutesCriteria) o;
        return (
