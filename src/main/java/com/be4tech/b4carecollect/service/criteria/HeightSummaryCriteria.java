...
/**
 * Criteria class for the {@link com.be4tech.b4carecollect.domain.HeightSummary} entity. This class is used
 * in {@link com.be4tech.b4carecollect.web.rest.HeightSummaryResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /height-summaries?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class HeightSummaryCriteria implements Serializable, Criteria {
    ...
    public HeightSummaryCriteria() {}

    public HeightSummaryCriteria(HeightSummaryCriteria other) {
    ...
    @Override
    public HeightSummaryCriteria copy() {
        return new HeightSummaryCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final HeightSummaryCriteria that = (HeightSummaryCriteria) o;
        return (
