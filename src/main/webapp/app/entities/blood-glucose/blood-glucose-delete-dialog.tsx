...
export const BloodGlucoseDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="b4CarecollectApp.bloodGlucose.delete.question">
        <Translate contentKey="b4CarecollectApp.bloodGlucose.delete.question" interpolate={{ id: bloodGlucoseEntity.id }}>
          Are you sure you want to delete this BloodGlucose?
        </Translate>
      </ModalBody>
      <ModalFooter>
