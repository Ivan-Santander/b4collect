...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './mental-health-summary.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MENTALHEALTHSUMMARY_LIST actions', async () => {
    ...
    it('dispatches FETCH_MENTALHEALTHSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MENTALHEALTHSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MENTALHEALTHSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MENTALHEALTHSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MENTALHEALTHSUMMARY actions', async () => {
      const expectedActions = [
        {
