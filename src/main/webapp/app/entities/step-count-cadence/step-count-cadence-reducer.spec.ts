...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './step-count-cadence.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STEPCOUNTCADENCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_STEPCOUNTCADENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STEPCOUNTCADENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STEPCOUNTCADENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STEPCOUNTCADENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STEPCOUNTCADENCE actions', async () => {
      const expectedActions = [
        {
