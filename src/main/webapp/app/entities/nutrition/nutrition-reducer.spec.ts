...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './nutrition.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NUTRITION_LIST actions', async () => {
    ...
    it('dispatches FETCH_NUTRITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NUTRITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NUTRITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NUTRITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NUTRITION actions', async () => {
      const expectedActions = [
        {
