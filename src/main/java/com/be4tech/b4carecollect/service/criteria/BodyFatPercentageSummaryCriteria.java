...
/**
 * Criteria class for the {@link com.be4tech.b4carecollect.domain.BodyFatPercentageSummary} entity. This class is used
 * in {@link com.be4tech.b4carecollect.web.rest.BodyFatPercentageSummaryResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /body-fat-percentage-summaries?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class BodyFatPercentageSummaryCriteria implements Serializable, Criteria {
    ...
    public BodyFatPercentageSummaryCriteria() {}

    public BodyFatPercentageSummaryCriteria(BodyFatPercentageSummaryCriteria other) {
    ...
    @Override
    public BodyFatPercentageSummaryCriteria copy() {
        return new BodyFatPercentageSummaryCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final BodyFatPercentageSummaryCriteria that = (BodyFatPercentageSummaryCriteria) o;
        return (
    ...
    public String toString() {
        return "BodyFatPercentageSummaryCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
