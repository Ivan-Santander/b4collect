...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERBODYINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERBODYINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERBODYINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERBODYINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERBODYINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERBODYINFO actions', async () => {
      const expectedActions = [
        {
