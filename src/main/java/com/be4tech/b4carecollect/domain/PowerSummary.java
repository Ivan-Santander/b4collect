...
public class PowerSummary implements Serializable {
    ...
    public PowerSummary id(UUID id) {
        this.setId(id);
        return this;
    }
    ...
    public PowerSummary usuarioId(String usuarioId) {
    ...
    public PowerSummary empresaId(String empresaId) {
    ...
    public PowerSummary fieldAverage(Float fieldAverage) {
    ...
    public PowerSummary fieldMax(Float fieldMax) {
    ...
    public PowerSummary fieldMin(Float fieldMin) {
    ...
    public PowerSummary startTime(Instant startTime) {
    ...
    public PowerSummary endTime(Instant endTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PowerSummary)) {
            return false;
        }
        return id != null && id.equals(((PowerSummary) o).id);
    }
