...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './calories-expended.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CALORIESEXPENDED_LIST actions', async () => {
    ...
    it('dispatches FETCH_CALORIESEXPENDED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CALORIESEXPENDED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CALORIESEXPENDED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CALORIESEXPENDED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CALORIESEXPENDED actions', async () => {
      const expectedActions = [
        {
