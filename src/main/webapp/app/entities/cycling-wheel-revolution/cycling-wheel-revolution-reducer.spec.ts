...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './cycling-wheel-revolution.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CYCLINGWHEELREVOLUTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_CYCLINGWHEELREVOLUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CYCLINGWHEELREVOLUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CYCLINGWHEELREVOLUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CYCLINGWHEELREVOLUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CYCLINGWHEELREVOLUTION actions', async () => {
      const expectedActions = [
        {
