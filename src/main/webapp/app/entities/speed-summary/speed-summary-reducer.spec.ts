...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPEEDSUMMARY_LIST actions', async () => {
    ...
    it('dispatches FETCH_SPEEDSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SPEEDSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SPEEDSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SPEEDSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SPEEDSUMMARY actions', async () => {
      const expectedActions = [
        {
