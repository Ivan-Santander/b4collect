...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './nutrition-summary.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NUTRITIONSUMMARY_LIST actions', async () => {
    ...
    it('dispatches FETCH_NUTRITIONSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NUTRITIONSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NUTRITIONSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NUTRITIONSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NUTRITIONSUMMARY actions', async () => {
      const expectedActions = [
        {
