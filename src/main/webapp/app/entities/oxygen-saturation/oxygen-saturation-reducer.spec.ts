...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './oxygen-saturation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OXYGENSATURATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_OXYGENSATURATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OXYGENSATURATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OXYGENSATURATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OXYGENSATURATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OXYGENSATURATION actions', async () => {
      const expectedActions = [
        {
