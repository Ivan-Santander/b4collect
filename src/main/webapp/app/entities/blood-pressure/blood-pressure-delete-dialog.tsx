...
export const BloodPressureDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="b4CarecollectApp.bloodPressure.delete.question">
        <Translate contentKey="b4CarecollectApp.bloodPressure.delete.question" interpolate={{ id: bloodPressureEntity.id }}>
