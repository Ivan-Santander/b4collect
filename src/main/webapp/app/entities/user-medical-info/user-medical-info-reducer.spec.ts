...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-medical-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERMEDICALINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERMEDICALINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERMEDICALINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERMEDICALINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERMEDICALINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERMEDICALINFO actions', async () => {
      const expectedActions = [
        {
