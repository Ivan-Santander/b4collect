...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './cicling-pedaling-cadence.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CICLINGPEDALINGCADENCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CICLINGPEDALINGCADENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CICLINGPEDALINGCADENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CICLINGPEDALINGCADENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CICLINGPEDALINGCADENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CICLINGPEDALINGCADENCE actions', async () => {
      const expectedActions = [
        {
