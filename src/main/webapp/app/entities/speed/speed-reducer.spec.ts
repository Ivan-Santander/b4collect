...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './speed.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPEED_LIST actions', async () => {
    ...
    it('dispatches FETCH_SPEED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SPEED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SPEED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SPEED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SPEED actions', async () => {
      const expectedActions = [
        {
