...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POWERSUMMARY_LIST actions', async () => {
    ...
    it('dispatches FETCH_POWERSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POWERSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POWERSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POWERSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POWERSUMMARY actions', async () => {
      const expectedActions = [
        {
