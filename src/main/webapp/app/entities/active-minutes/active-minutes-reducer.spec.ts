...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTIVEMINUTES_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACTIVEMINUTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACTIVEMINUTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACTIVEMINUTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACTIVEMINUTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACTIVEMINUTES actions', async () => {
      const expectedActions = [
        {
