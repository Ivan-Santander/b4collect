...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './body-fat-percentage.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BODYFATPERCENTAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_BODYFATPERCENTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BODYFATPERCENTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BODYFATPERCENTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BODYFATPERCENTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BODYFATPERCENTAGE actions', async () => {
      const expectedActions = [
        {
