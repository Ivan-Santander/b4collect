...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './blood-glucose-summary.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BLOODGLUCOSESUMMARY_LIST actions', async () => {
    ...
    it('dispatches FETCH_BLOODGLUCOSESUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BLOODGLUCOSESUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BLOODGLUCOSESUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BLOODGLUCOSESUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BLOODGLUCOSESUMMARY actions', async () => {
      const expectedActions = [
        {
