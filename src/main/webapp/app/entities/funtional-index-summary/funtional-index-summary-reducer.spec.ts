...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './funtional-index-summary.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FUNTIONALINDEXSUMMARY_LIST actions', async () => {
    ...
    it('dispatches FETCH_FUNTIONALINDEXSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FUNTIONALINDEXSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FUNTIONALINDEXSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FUNTIONALINDEXSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FUNTIONALINDEXSUMMARY actions', async () => {
      const expectedActions = [
        {
