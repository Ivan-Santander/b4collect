...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEIGHTSUMMARY_LIST actions', async () => {
    ...
    it('dispatches FETCH_WEIGHTSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WEIGHTSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WEIGHTSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WEIGHTSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WEIGHTSUMMARY actions', async () => {
      const expectedActions = [
        {
