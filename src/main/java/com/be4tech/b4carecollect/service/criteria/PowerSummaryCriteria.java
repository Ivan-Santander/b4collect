...
/**
 * Criteria class for the {@link com.be4tech.b4carecollect.domain.PowerSummary} entity. This class is used
 * in {@link com.be4tech.b4carecollect.web.rest.PowerSummaryResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /power-summaries?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class PowerSummaryCriteria implements Serializable, Criteria {
    ...
    public PowerSummaryCriteria() {}

    public PowerSummaryCriteria(PowerSummaryCriteria other) {
    ...
    @Override
    public PowerSummaryCriteria copy() {
        return new PowerSummaryCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final PowerSummaryCriteria that = (PowerSummaryCriteria) o;
        return (
