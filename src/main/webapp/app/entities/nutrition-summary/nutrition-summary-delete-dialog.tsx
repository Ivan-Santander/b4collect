...
export const NutritionSummaryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="b4CarecollectApp.nutritionSummary.delete.question">
        <Translate contentKey="b4CarecollectApp.nutritionSummary.delete.question" interpolate={{ id: nutritionSummaryEntity.id }}>
          Are you sure you want to delete this NutritionSummary?
        </Translate>
      </ModalBody>
      <ModalFooter>
