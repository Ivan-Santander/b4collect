...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MENTALHEALTH_LIST actions', async () => {
    ...
    it('dispatches FETCH_MENTALHEALTH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MENTALHEALTH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MENTALHEALTH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MENTALHEALTH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MENTALHEALTH actions', async () => {
      const expectedActions = [
        {
