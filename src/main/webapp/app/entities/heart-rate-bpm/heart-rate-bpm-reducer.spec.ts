...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HEARTRATEBPM_LIST actions', async () => {
    ...
    it('dispatches FETCH_HEARTRATEBPM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HEARTRATEBPM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HEARTRATEBPM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HEARTRATEBPM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HEARTRATEBPM actions', async () => {
      const expectedActions = [
        {
