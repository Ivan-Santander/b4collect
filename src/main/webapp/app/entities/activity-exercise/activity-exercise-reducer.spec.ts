...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './activity-exercise.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTIVITYEXERCISE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACTIVITYEXERCISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACTIVITYEXERCISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACTIVITYEXERCISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACTIVITYEXERCISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACTIVITYEXERCISE actions', async () => {
      const expectedActions = [
        {
