...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './oxygen-saturation-summary.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OXYGENSATURATIONSUMMARY_LIST actions', async () => {
    ...
    it('dispatches FETCH_OXYGENSATURATIONSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OXYGENSATURATIONSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OXYGENSATURATIONSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OXYGENSATURATIONSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OXYGENSATURATIONSUMMARY actions', async () => {
      const expectedActions = [
        {
