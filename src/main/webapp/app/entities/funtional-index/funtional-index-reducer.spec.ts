...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FUNTIONALINDEX_LIST actions', async () => {
    ...
    it('dispatches FETCH_FUNTIONALINDEX actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FUNTIONALINDEX actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FUNTIONALINDEX actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FUNTIONALINDEX actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FUNTIONALINDEX actions', async () => {
      const expectedActions = [
        {
