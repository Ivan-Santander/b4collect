...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POWESAMPLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_POWESAMPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POWESAMPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POWESAMPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POWESAMPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POWESAMPLE actions', async () => {
      const expectedActions = [
        {
