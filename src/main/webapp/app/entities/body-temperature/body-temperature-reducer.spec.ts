...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BODYTEMPERATURE_LIST actions', async () => {
    ...
    it('dispatches FETCH_BODYTEMPERATURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BODYTEMPERATURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BODYTEMPERATURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BODYTEMPERATURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BODYTEMPERATURE actions', async () => {
      const expectedActions = [
        {
