...
export const NutritionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="b4CarecollectApp.nutrition.delete.question">
        <Translate contentKey="b4CarecollectApp.nutrition.delete.question" interpolate={{ id: nutritionEntity.id }}>
