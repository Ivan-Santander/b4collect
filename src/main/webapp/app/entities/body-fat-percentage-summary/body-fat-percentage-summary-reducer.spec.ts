...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './body-fat-percentage-summary.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BODYFATPERCENTAGESUMMARY_LIST actions', async () => {
    ...
    it('dispatches FETCH_BODYFATPERCENTAGESUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BODYFATPERCENTAGESUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BODYFATPERCENTAGESUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BODYFATPERCENTAGESUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BODYFATPERCENTAGESUMMARY actions', async () => {
      const expectedActions = [
        {
