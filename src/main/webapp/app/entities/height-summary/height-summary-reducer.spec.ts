...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HEIGHTSUMMARY_LIST actions', async () => {
    ...
    it('dispatches FETCH_HEIGHTSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HEIGHTSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HEIGHTSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HEIGHTSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HEIGHTSUMMARY actions', async () => {
      const expectedActions = [
        {
