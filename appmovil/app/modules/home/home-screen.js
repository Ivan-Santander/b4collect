    ...
    <View style={[styles.container, styles.mainContainer]} testID="homeScreen">
      <ScrollView contentInsetAdjustmentBehavior="automatic" style={styles.scrollView}>
        <View style={styles.centered}>
          ...
          {/* <Text style={styles.welcomeText}>collectapp</Text> */}
          <Text style={styles.welcomeText}>Bienvenido a Be4care Collect.</Text>
        </View>
        {account && account.login ? (
          <View style={[styles.authContainer, styles.authContainerTrue]} testID="authDisplayTrue">
            <Text style={styles.authText}>
              <Ionicons name="md-checkmark-circle" size={22} color={'white'} /> Ingresaste como usuario: {account.login}
            </Text>
            <Text style={styles.sectionTitle}>Tus datos descargados son:</Text>
            <LearnMoreLinks />
          </View>
        ) : (
          <View style={[styles.authContainer, styles.authContainerFalse]} testID="authDisplayFalse">
            <Text style={styles.authText}>
              <Ionicons name="md-information-circle" size={22} color={'white'} /> No has ingresado.
            </Text>
          </View>
        )}
