...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './height.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HEIGHT_LIST actions', async () => {
    ...
    it('dispatches FETCH_HEIGHT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HEIGHT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HEIGHT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HEIGHT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HEIGHT actions', async () => {
      const expectedActions = [
        {
