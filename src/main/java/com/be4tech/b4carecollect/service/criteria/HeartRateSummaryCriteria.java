...
/**
 * Criteria class for the {@link com.be4tech.b4carecollect.domain.HeartRateSummary} entity. This class is used
 * in {@link com.be4tech.b4carecollect.web.rest.HeartRateSummaryResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /heart-rate-summaries?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class HeartRateSummaryCriteria implements Serializable, Criteria {
    ...
    public HeartRateSummaryCriteria() {}

    public HeartRateSummaryCriteria(HeartRateSummaryCriteria other) {
    ...
    @Override
    public HeartRateSummaryCriteria copy() {
        return new HeartRateSummaryCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final HeartRateSummaryCriteria that = (HeartRateSummaryCriteria) o;
        return (
    ...
    public String toString() {
        return "HeartRateSummaryCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
