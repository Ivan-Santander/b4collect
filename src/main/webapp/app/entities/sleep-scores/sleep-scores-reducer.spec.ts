...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SLEEPSCORES_LIST actions', async () => {
    ...
    it('dispatches FETCH_SLEEPSCORES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SLEEPSCORES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SLEEPSCORES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SLEEPSCORES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SLEEPSCORES actions', async () => {
      const expectedActions = [
        {
