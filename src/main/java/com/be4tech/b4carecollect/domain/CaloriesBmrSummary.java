...
/**
 * A CaloriesBmrSummary.
 */
@Entity
@Table(name = "calories_bmr_summary")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CaloriesBmrSummary implements Serializable {
    ...
    public CaloriesBmrSummary id(UUID id) {
        this.setId(id);
        return this;
    }
    ...
    public CaloriesBmrSummary usuarioId(String usuarioId) {
    ...
    public CaloriesBmrSummary empresaId(String empresaId) {
    ...
    public CaloriesBmrSummary fieldAverage(Float fieldAverage) {
    ...
    public CaloriesBmrSummary fieldMax(Float fieldMax) {
    ...
    public CaloriesBmrSummary fieldMin(Float fieldMin) {
    ...
    public CaloriesBmrSummary startTime(Instant startTime) {
    ...
    public CaloriesBmrSummary endTime(Instant endTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CaloriesBmrSummary)) {
            return false;
        }
        return id != null && id.equals(((CaloriesBmrSummary) o).id);
    }
