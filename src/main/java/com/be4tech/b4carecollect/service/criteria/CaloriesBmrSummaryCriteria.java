...
/**
 * Criteria class for the {@link com.be4tech.b4carecollect.domain.CaloriesBmrSummary} entity. This class is used
 * in {@link com.be4tech.b4carecollect.web.rest.CaloriesBmrSummaryResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /calories-bmr-summaries?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CaloriesBmrSummaryCriteria implements Serializable, Criteria {
    ...
    public CaloriesBmrSummaryCriteria() {}

    public CaloriesBmrSummaryCriteria(CaloriesBmrSummaryCriteria other) {
    ...
    @Override
    public CaloriesBmrSummaryCriteria copy() {
        return new CaloriesBmrSummaryCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CaloriesBmrSummaryCriteria that = (CaloriesBmrSummaryCriteria) o;
        return (
    ...
    public String toString() {
        return "CaloriesBmrSummaryCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
