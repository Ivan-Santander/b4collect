...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HEARTMINUTES_LIST actions', async () => {
    ...
    it('dispatches FETCH_HEARTMINUTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HEARTMINUTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HEARTMINUTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HEARTMINUTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HEARTMINUTES actions', async () => {
      const expectedActions = [
        {
