...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CALORIESBMR_LIST actions', async () => {
    ...
    it('dispatches FETCH_CALORIESBMR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CALORIESBMR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CALORIESBMR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CALORIESBMR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CALORIESBMR actions', async () => {
      const expectedActions = [
        {
