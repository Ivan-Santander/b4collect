...
/**
 * Criteria class for the {@link com.be4tech.b4carecollect.domain.WeightSummary} entity. This class is used
 * in {@link com.be4tech.b4carecollect.web.rest.WeightSummaryResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /weight-summaries?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class WeightSummaryCriteria implements Serializable, Criteria {
    ...
    public WeightSummaryCriteria() {}

    public WeightSummaryCriteria(WeightSummaryCriteria other) {
    ...
    @Override
    public WeightSummaryCriteria copy() {
        return new WeightSummaryCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final WeightSummaryCriteria that = (WeightSummaryCriteria) o;
        return (
