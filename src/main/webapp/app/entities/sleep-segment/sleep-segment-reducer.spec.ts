...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SLEEPSEGMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_SLEEPSEGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SLEEPSEGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SLEEPSEGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SLEEPSEGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SLEEPSEGMENT actions', async () => {
      const expectedActions = [
        {
