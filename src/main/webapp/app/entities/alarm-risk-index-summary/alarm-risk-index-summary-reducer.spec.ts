...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './alarm-risk-index-summary.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ALARMRISKINDEXSUMMARY_LIST actions', async () => {
    ...
    it('dispatches FETCH_ALARMRISKINDEXSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ALARMRISKINDEXSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ALARMRISKINDEXSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ALARMRISKINDEXSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ALARMRISKINDEXSUMMARY actions', async () => {
      const expectedActions = [
        {
