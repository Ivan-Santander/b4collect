...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOCATIONSAMPLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOCATIONSAMPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOCATIONSAMPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOCATIONSAMPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOCATIONSAMPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOCATIONSAMPLE actions', async () => {
      const expectedActions = [
        {
