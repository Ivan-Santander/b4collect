...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './calories-bmr-summary.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CALORIESBMRSUMMARY_LIST actions', async () => {
    ...
    it('dispatches FETCH_CALORIESBMRSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CALORIESBMRSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CALORIESBMRSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CALORIESBMRSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CALORIESBMRSUMMARY actions', async () => {
      const expectedActions = [
        {
