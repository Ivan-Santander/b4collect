...
/**
 * Criteria class for the {@link com.be4tech.b4carecollect.domain.TemperatureSummary} entity. This class is used
 * in {@link com.be4tech.b4carecollect.web.rest.TemperatureSummaryResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /temperature-summaries?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class TemperatureSummaryCriteria implements Serializable, Criteria {
    ...
    public TemperatureSummaryCriteria() {}

    public TemperatureSummaryCriteria(TemperatureSummaryCriteria other) {
    ...
    @Override
    public TemperatureSummaryCriteria copy() {
        return new TemperatureSummaryCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final TemperatureSummaryCriteria that = (TemperatureSummaryCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, usuarioId, empresaId, fieldAverage, fieldMax, fieldMin, measurementLocation, startTime, endTime, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "TemperatureSummaryCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
