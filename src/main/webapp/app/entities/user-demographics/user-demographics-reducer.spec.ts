...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-demographics.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERDEMOGRAPHICS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERDEMOGRAPHICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERDEMOGRAPHICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERDEMOGRAPHICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERDEMOGRAPHICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERDEMOGRAPHICS actions', async () => {
      const expectedActions = [
        {
