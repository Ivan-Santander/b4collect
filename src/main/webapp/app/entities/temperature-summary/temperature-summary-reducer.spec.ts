...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './temperature-summary.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEMPERATURESUMMARY_LIST actions', async () => {
    ...
    it('dispatches FETCH_TEMPERATURESUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TEMPERATURESUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TEMPERATURESUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TEMPERATURESUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TEMPERATURESUMMARY actions', async () => {
      const expectedActions = [
        {
