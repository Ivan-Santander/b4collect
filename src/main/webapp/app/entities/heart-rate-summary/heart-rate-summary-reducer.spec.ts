...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './heart-rate-summary.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HEARTRATESUMMARY_LIST actions', async () => {
    ...
    it('dispatches FETCH_HEARTRATESUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HEARTRATESUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HEARTRATESUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HEARTRATESUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HEARTRATESUMMARY actions', async () => {
      const expectedActions = [
        {
