...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTIVITYSUMMARY_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACTIVITYSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACTIVITYSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACTIVITYSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACTIVITYSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACTIVITYSUMMARY actions', async () => {
      const expectedActions = [
        {
